                    ...
                    <div class="flex items-center gap-2 justify-between">
                        ...
                        <div>
                            <form method="POST" action="" class="flex flex-col md:flex-row gap-5">
                                ...
                                <button type="button" class="edit-button" onclick="openUpdateModal(<?php echo $data['reservasi_id']; ?>, '<?php echo $data['nama']; ?>', '<?php echo $data['alamat']; ?>', '<?php echo $data['usia']; ?>', '<?php echo $data['layanan']; ?>', '<?php echo $data['tanggal']; ?>', '<?php echo $data['waktu']; ?>')">
